...
go get github.com/aultimus/webrtc/v3/examples/rtp-to-webrtc
```
...
Pion WebRTC also provides a [SampleBuilder](https://pkg.go.dev/github.com/aultimus/webrtc/v3@v3.0.4/pkg/media/samplebuilder). This consumes RTP packets and returns samples.
